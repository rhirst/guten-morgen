...
} from "./chunk-BXJNIJKG.js";
import {
  Combination_default,
  FocusScope,
  hideOthers,
  useFocusGuards
} from "./chunk-KZ777HGL.js";
import {
  Anchor,
  Arrow,
  Content,
  Root2,
  createPopperScope
} from "./chunk-JEJ5BD6S.js";
import "./chunk-RNGYTGTZ.js";
import {
  Portal
} from "./chunk-ZXV2BLQ3.js";
import {
  DismissableLayer
} from "./chunk-3IH646L3.js";
import {
  useCallbackRef
} from "./chunk-DEH6TPKA.js";
import {
  createCollection
} from "./chunk-ILFQXEHN.js";
import {
  useDirection
} from "./chunk-X3UJEI7H.js";
import {
  useId
} from "./chunk-KDSUDGKA.js";
import {
  useControllableState
} from "./chunk-FQMHN4Z7.js";
import {
  Presence
} from "./chunk-CBVQPCBI.js";
import {
  composeEventHandlers
} from "./chunk-PHAGNGCT.js";
import "./chunk-P2MRDKEM.js";
import "./chunk-3ZDEN542.js";
import {
  createContextScope
} from "./chunk-7QZJIHFZ.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-JAYMFAYS.js";
import {
  createSlot,
  useComposedRefs
} from "./chunk-CP5RPHSZ.js";
import {
  require_jsx_runtime
} from "./chunk-6NDBMSTA.js";
import "./chunk-T57AXV6E.js";
import {
  require_react
} from "./chunk-346CAX4M.js";
import {
  __toESM
...
var Menu = __name((props) => {
  ...
  React.useEffect(() => {
    const handleKeyDown = __name(() => {
      isUsingKeyboardRef.current = true;
      document.addEventListener("pointerdown", handlePointer, { capture: true, once: true });
      document.addEventListener("pointermove", handlePointer, { capture: true, once: true });
    }, "handleKeyDown");
    const handlePointer = __name(() => isUsingKeyboardRef.current = false, "handlePointer");
  ...
  React.useEffect(() => {
    ...
    const handleBlur = __name(() => handleOpenChange(false), "handleBlur");
...
var MenuAnchor = React.forwardRef(
  __name(function MenuAnchor2(props, forwardedRef) {
...
var MenuContent = React.forwardRef(
  __name(function MenuContent2(props, forwardedRef) {
...
var MenuRootContentModal = React.forwardRef(
  ...
  __name(function MenuRootContentModal2(props, forwardedRef) {
    const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
...
var MenuRootContentNonModal = React.forwardRef(__name(function MenuRootContentNonModal2(props, forwardedRef) {
  const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
  return (0, import_jsx_runtime.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React.forwardRef(
  // blank line to reduce diff noise
  __name(function MenuContentImpl2(props, forwardedRef) {
    const {
      __scopeMenu,
      loop = false,
      trapFocus,
    ...
    const handleTypeaheadSearch = __name((key) => {
      ...
      __name((function updateSearch(value) {
...
var MenuItem = React.forwardRef(
  // blank line to reduce diff noise
  __name(function MenuItem2(props, forwardedRef) {
...
var MenuItemImpl = React.forwardRef(
  __name(function MenuItemImpl2(props, forwardedRef) {
...
var MenuCheckboxItem = React.forwardRef(
  // blank line to reduce diff noise
  __name(function MenuCheckboxItem2(props, forwardedRef) {
...
var [RadioGroupProvider, useRadioGroupContext] = createMenuContext(
  RADIO_GROUP_NAME,
  { value: void 0, onValueChange: __name(() => {
  }, "onValueChange") }
);
var MenuRadioGroup = React.forwardRef(
  __name(function MenuRadioGroup2(props, forwardedRef) {
...
var MenuRadioItem = React.forwardRef(
  __name(function MenuRadioItem2(props, forwardedRef) {
...
var MenuItemIndicator = React.forwardRef(
  // blank line to reduce diff noise
  __name(function MenuItemIndicator2(props, forwardedRef) {
...
var MenuSeparator = React.forwardRef(
  __name(function MenuSeparator2(props, forwardedRef) {
...
var MenuArrow = React.forwardRef(
  __name(function MenuArrow2(props, forwardedRef) {
...
var MenuSubTrigger = React.forwardRef(
  __name(function MenuSubTrigger2(props, forwardedRef) {
...
var MenuSubContent = React.forwardRef(
  __name(function MenuSubContent2(props, forwardedRef) {
    const portalContext = usePortalContext(CONTENT_NAME, props.__scopeMenu);
...
var DropdownMenu = __name2((props) => {
  const {
    __scopeDropdownMenu,
    children,
    dir,
...
var DropdownMenuTrigger = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function DropdownMenuTrigger2(props, forwardedRef) {
...
var DropdownMenuPortal = __name2((props) => {
...
var DropdownMenuContent = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function DropdownMenuContent2(props, forwardedRef) {
...
var DropdownMenuGroup = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function DropdownMenuGroup2(props, forwardedRef) {
...
var DropdownMenuLabel = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function DropdownMenuLabel2(props, forwardedRef) {
...
var DropdownMenuItem = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function DropdownMenuItem2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime2.jsx)(Item2, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "DropdownMenuItem")
);
var DropdownMenuCheckboxItem = React2.forwardRef(__name2(function DropdownMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime2.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "DropdownMenuCheckboxItem"));
var DropdownMenuRadioGroup = React2.forwardRef(__name2(function DropdownMenuRadioGroup2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime2.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "DropdownMenuRadioGroup"));
var DropdownMenuRadioItem = React2.forwardRef(__name2(function DropdownMenuRadioItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime2.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "DropdownMenuRadioItem"));
var DropdownMenuItemIndicator = React2.forwardRef(__name2(function DropdownMenuItemIndicator2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime2.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "DropdownMenuItemIndicator"));
var DropdownMenuSeparator = React2.forwardRef(__name2(function DropdownMenuSeparator2(props, forwardedRef) {
...
var DropdownMenuArrow = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function DropdownMenuArrow2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime2.jsx)(Arrow2, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }, "DropdownMenuArrow")
);
var DropdownMenuSub = __name2((props) => {
...
var DropdownMenuSubTrigger = React2.forwardRef(__name2(function DropdownMenuSubTrigger2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime2.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
}, "DropdownMenuSubTrigger"));
var DropdownMenuSubContent = React2.forwardRef(__name2(function DropdownMenuSubContent2(props, forwardedRef) {
