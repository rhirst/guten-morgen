...
var NavigationMenu = React.forwardRef(
  __name(function NavigationMenu2(props, forwardedRef) {
    const {
...
var NavigationMenuSub = React.forwardRef(
  ...
  __name(function NavigationMenuSub2(props, forwardedRef) {
    const {
      __scopeNavigationMenu,
      value: valueProp,
      onValueChange,
...
var NavigationMenuProvider = __name((props) => {
  const {
    scope,
    isRootMenu,
    rootNavigationMenu,
...
var NavigationMenuList = React.forwardRef(
  // blank line to reduce diff noise
  __name(function NavigationMenuList2(props, forwardedRef) {
...
var NavigationMenuItem = React.forwardRef(
  // blank line to reduce diff noise
  __name(function NavigationMenuItem2(props, forwardedRef) {
...
var NavigationMenuTrigger = React.forwardRef(__name(function NavigationMenuTrigger2(props, forwardedRef) {
...
var NavigationMenuLink = React.forwardRef(
  // blank line to reduce diff noise
  __name(function NavigationMenuLink2(props, forwardedRef) {
...
var NavigationMenuIndicator = React.forwardRef(__name(function NavigationMenuIndicator2(props, forwardedRef) {
...
var NavigationMenuIndicatorImpl = React.forwardRef(__name(function NavigationMenuIndicatorImpl2(props, forwardedRef) {
  ...
  const handlePositionChange = __name(() => {
    if (activeTrigger) {
      setPosition({
...
var NavigationMenuContent = React.forwardRef(__name(function NavigationMenuContent2(props, forwardedRef) {
...
var ViewportContentMounter = React.forwardRef(__name(function ViewportContentMounter2(props, forwardedRef) {
  const context = useNavigationMenuContext(CONTENT_NAME, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React.forwardRef(__name(function NavigationMenuContentImpl2(props, forwardedRef) {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
...
var NavigationMenuViewport = React.forwardRef(__name(function NavigationMenuViewport2(props, forwardedRef) {
...
var NavigationMenuViewportImpl = React.forwardRef(__name(function NavigationMenuViewportImpl2(props, forwardedRef) {
...
var NavigationMenuViewportItem = __name(({
  contentRef,
  isActive,
  ...
  return (0, import_jsx_runtime.jsx)(NavigationMenuContentImpl, { ...props, ref: composedRefs });
}, "NavigationMenuViewportItem");
var FOCUS_GROUP_NAME = "FocusGroup";
var FocusGroup = React.forwardRef(
  __name(function FocusGroup2(props, forwardedRef) {
...
var FocusGroupItem = React.forwardRef(
  __name(function FocusGroupItem2(props, forwardedRef) {
    const { __scopeNavigationMenu, ...groupProps } = props;
